...
namespace WebApi.netcoreMvcDemo
{
    public class EmployeeService : IEmployee
    {
        ...
        public async Task<List<EmployeeDto>> GetAllEmployeeBasicInfoAsync(int pageNumber, int pageSize)
        {
            ...
            var basicList = employees.Select(e => new EmployeeDto
            {
